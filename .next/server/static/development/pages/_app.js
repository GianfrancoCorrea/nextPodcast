          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()("https://api.audioboom.com/channels/".concat(category));
...
function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function componentDidMount() {
      ...
      reduxStore.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_4__["fetchCategory"])('recommended'));
    }
  }, {
    key: "render",
    value: function render() {
...
function selectedCategory() {
  ...
  switch (action.type) {
    case _actions__WEBPACK_IMPORTED_MODULE_1__["actionTypes"].SELECT_CATEGORY:
...
function categoryChannels() {
  ...
  switch (action.type) {
    case _actions__WEBPACK_IMPORTED_MODULE_1__["actionTypes"].REQUEST_CATEGORY:
      return Object.assign({}, state, {
        isFetching: true
      });

    case _actions__WEBPACK_IMPORTED_MODULE_1__["actionTypes"].RECEIVE_CATEGORY:
      return Object.assign({}, state, {
        isFetching: false,
